...
11. 같은 KST 월에 두 번 로그인해 두 번째 Drive 대조가 생략되는지 확인합니다.
12. 초기화 후 다음 달 첫 로그인에서 복원 또는 정리를 선택할 수 있는지 확인합니다.
13. 테스트 이미지의 캐러셀 개별 삭제와 테스트 계정 회원 탈퇴의 Drive/R2 정리를 확인합니다.
